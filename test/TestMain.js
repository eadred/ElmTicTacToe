...
var _user$project$TestMain$tests = A2(
...
var _user$project$TestMain$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$TestMain$tests)
};

var Elm = {};
Elm['TestMain'] = Elm['TestMain'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['TestMain'], 'TestMain', typeof _user$project$TestMain$main === 'undefined' ? null : _user$project$TestMain$main);
